import { PathNormalizerUtility } from '@/lib/utils/formatting/PathNormalizerUtil';
import type { NextRequest } from 'next/server';
import type { EndpointsMap, EndpointConfig, RouteValidation } from '@/lib/routes/types';
