import { SystemPromptRepository } from "@/lib/domain/ai-prompt/system-prompt.repository";
import { BaseService } from "@/lib/domain/base/base.service";
import { AuthContext } from "@/lib/domain/base/types";
import { Database } from "@/lib/database";
import { BASE_PROMPTS } from "@/lib/domain/ai-prompt/base-prompts";
...
export class SystemPromptService extends BaseService {
    ...
    async getEffectivePromptResult(flowType: string, variables: Record<string, unknown>) {
        try {
     ...
     */
    hydrateValues(template: string, variables: Record<string, unknown>): string {
        let result = template;
