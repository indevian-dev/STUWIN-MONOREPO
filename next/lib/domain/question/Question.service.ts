...
export class QuestionService extends BaseService {
    ...
    async list(params: {
        ...
        gradeLevel?: number; authorAccountId?: string; onlyPublished?: boolean; onlyUnpublished?: boolean; workspaceId?: string;
    }) {
        try {
            ...
            const [questions, total] = await Promise.all([
                this.repository.list({ limit: pageSize, offset, providerSubjectId: params.subjectId, complexity: params.complexity, gradeLevel: params.gradeLevel, authorAccountId: params.authorAccountId, onlyPublished: params.onlyPublished, onlyUnpublished: params.onlyUnpublished, workspaceId: params.workspaceId }),
                this.repository.count({ providerSubjectId: params.subjectId, complexity: params.complexity, gradeLevel: params.gradeLevel, authorAccountId: params.authorAccountId, onlyPublished: params.onlyPublished, onlyUnpublished: params.onlyUnpublished, workspaceId: params.workspaceId })
            ]);
