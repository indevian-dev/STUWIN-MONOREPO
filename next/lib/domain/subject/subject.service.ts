...
export class SubjectService extends BaseService {
    ...
    async create(data: { title: string; description: string; language: string; gradeLevel: number; cover?: string; aiLabel?: string; isGlobal?: boolean; organizationId?: string; workspaceId?: string; aiAssistantCrib?: string; }) {
        try {
            ...
            const newSubject = await this.repository.create({
                ...
                slug, cover: data.cover, aiLabel: data.aiLabel, workspaceId: data.workspaceId, aiAssistantCrib: data.aiAssistantCrib,
    ...
    async getCoverUploadUrl(subjectId: string, fileName: string, fileType: string) {
        try {
