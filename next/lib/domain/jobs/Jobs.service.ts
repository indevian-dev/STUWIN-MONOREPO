...
import {
    ...
    resumeSchedule,
    triggerJob,
} from '@/lib/integrations/upstash/QstashScheduler';
import { DbClient } from "@/lib/database";
import { qstashClient } from '@/lib/integrations/upstash/Qstash.client';
import axiomClient, { logScannerBatch, logWorkerProcessing, logTopicWorker, AXIOM_BACKGROUND_JOB_DATASET } from '@/lib/integrations/axiom/Axiom.client';
import { randomUUID } from 'crypto';
import { genAI } from "@/lib/integrations/google/Gemini.client";
            ...
            for (const topic of topicsToProcess) {
                try {
                    ...
                    const topicData: any = {
                        ...
                        pdfPageStart: topic.pdfDetails?.pages?.start,
                        pdfPageEnd: topic.pdfDetails?.pages?.end,
