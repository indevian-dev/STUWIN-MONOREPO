...
import type { EndpointsMap } from "@/lib/routes/types";
...
export const staffEndpoints: EndpointsMap = {
  ...
  "/api/workspaces/staff/:workspaceId/blogs/update/:id": createStaffEndpoint({
    method: "PUT",
    authRequired: true,
    permission: "STAFF_PAGE_UPDATE",
    type: "api",
  }),
  "/api/workspaces/staff/:workspaceId/blogs/delete/:id": createStaffEndpoint({
    method: "DELETE",
    authRequired: true,
    permission: "STAFF_PAGE_UPDATE",
    type: "api",
  ...
  "/workspaces/staff/:workspaceId/docs": createStaffEndpoint({
    method: "GET",
    authRequired: true,
    permission: "STAFF_PAGE_READ",
    type: "page",
  }),
  "/workspaces/staff/:workspaceId/docs/faq": createStaffEndpoint({
    method: "GET",
    authRequired: true,
    permission: "STAFF_PAGE_UPDATE",
    type: "page",
  }),
  "/workspaces/staff/:workspaceId/docs/terms": createStaffEndpoint({
    method: "GET",
    authRequired: true,
    permission: "STAFF_PAGE_UPDATE",
    type: "page",
  }),
  "/workspaces/staff/:workspaceId/docs/privacy": createStaffEndpoint({
    method: "GET",
    authRequired: true,
    permission: "STAFF_PAGE_UPDATE",
    type: "page",
  }),
  "/workspaces/staff/:workspaceId/docs/about": createStaffEndpoint({
    method: "GET",
    authRequired: true,
    permission: "STAFF_PAGE_UPDATE",
    type: "page",
  }),
  "/workspaces/staff/:workspaceId/docs/rules": createStaffEndpoint({
    method: "GET",
    authRequired: true,
    permission: "STAFF_PAGE_UPDATE",
    type: "page",
  ...
  // ============================================
  "/api/workspaces/staff/:workspaceId/accounts/search": createStaffEndpoint({
    method: "GET",
    authRequired: true,
    permission: "STAFF_ACCOUNT_READ",
    type: "api",
  }),
  "/api/workspaces/staff/:workspaceId/accounts/:id/workspaces": createStaffEndpoint({
    method: "GET",
    authRequired: true,
    permission: "STAFF_ACCOUNT_READ",
    type: "api",
  }),
  "/api/workspaces/staff/:workspaceId/memberships/add-staff": createStaffEndpoint({
    method: "POST",
    authRequired: true,
    permission: "STAFF_ACCOUNT_CREATE",
    twoFactorAuth: true,
  ...
  // ============================================
  "/workspaces/staff/:workspaceId/manage-workspaces": createStaffEndpoint({
    method: "GET",
    authRequired: true,
    permission: "STAFF_ACCOUNT_READ",
    type: "page",
