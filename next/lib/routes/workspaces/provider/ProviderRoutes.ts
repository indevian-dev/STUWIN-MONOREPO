...
export const providerEndpoints: EndpointsMap = {
  ...
  // ============================================
  "/workspaces/provider/:workspaceId/members": createProviderEndpoint({
    method: "GET",
    authRequired: true,
    permission: "PROVIDER_STAFF_READ",
    type: "page",
  }),
  "/api/workspaces/provider/:workspaceId/members": createProviderEndpoint({
    method: "GET",
    authRequired: true,
    permission: "PROVIDER_STAFF_READ",
    type: "api",
  }),
  "/api/workspaces/provider/:workspaceId/members/search": createProviderEndpoint({
    method: "GET",
    authRequired: true,
    permission: "PROVIDER_STAFF_READ",
    type: "api",
  }),
  "/api/workspaces/provider/:workspaceId/members/add": createProviderEndpoint({
    method: "POST",
    authRequired: true,
