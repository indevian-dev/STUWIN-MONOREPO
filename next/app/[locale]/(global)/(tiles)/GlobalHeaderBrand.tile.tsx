...
import { GlobalLogoTile } from './GlobalLogo.tile';
...
export function GlobalHeaderBrandTile({
  ...
  return (
    <Link
      href={href}
      className="inline-flex items-center gap-2 rounded-app-full border border-slate-200 bg-white/90 px-3 py-2 shadow-sm hover:-translate-y-0.5 hover:shadow-md transition"
    >
