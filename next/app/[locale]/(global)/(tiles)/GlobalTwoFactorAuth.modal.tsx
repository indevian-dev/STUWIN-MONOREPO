...
export function GlobalTwoFactorAuthModal() {
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center">
            ...
            {/* Modal */}
            <div className="relative w-full max-w-md mx-4 bg-white rounded-app shadow-2xl border border-gray-100 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                {/* Header */}
                <div className="relative px-6 pt-6 pb-4">
                    <button
                        onClick={hideTwoFactorModal}
                        className="absolute top-4 right-4 p-2 rounded-app hover:bg-gray-100 transition-colors text-gray-400 hover:text-gray-600"
                    >
                        <PiX className="w-5 h-5" />
                    </button>

                    <div className="flex items-center gap-3 mb-2">
                        <div className="w-10 h-10 rounded-app bg-blue-50 flex items-center justify-center">
                ...
                <div className="px-6 pb-6">
                    {!otpSent && sendingOtp ? (
                        ...
                        <div className="flex flex-col items-center gap-4 py-6">
                            <div className="w-12 h-12 rounded-app-full bg-amber-50 flex items-center justify-center">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-app hover:bg-blue-700 transition-colors"
                            >
                                Retry Send
                            </button>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 px-3 py-2 bg-blue-50 rounded-app">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="000000"
                                    className="w-full px-4 py-3 text-center text-2xl font-mono tracking-[0.5em] border border-gray-200 rounded-app focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder:text-gray-300"
                                    disabled={isLoading}
                                />
                            </div>
                            ...
                            {/* Error display */}
                            {error && (
                                <div className="flex items-center gap-2 px-3 py-2 bg-red-50 text-red-700 rounded-app text-sm">
                            ...
                            <div className="flex items-center justify-between pt-2">
                                ...
                                <button
                                    ...
                                    className="px-5 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-app hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                                >
                                    {isLoading ? (
                                        <>
