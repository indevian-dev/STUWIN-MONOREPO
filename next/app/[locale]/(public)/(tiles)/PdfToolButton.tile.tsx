...
export function PdfToolButtonTile() {
  ...
  return (
    <section id="pdf-tools" className="w-full my-6 lg:my-10">
      <div className="max-w-7xl mx-auto bg-white/80 backdrop-blur rounded-app border border-slate-100 shadow-lg px-6 py-8 md:px-10 md:py-12">
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          <div>
            <Link
              href="/pdf-tool"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-app-full bg-emerald-500 hover:bg-emerald-600 text-white font-semibold shadow hover:-translate-y-0.5 transition transform duration-150"
            >
              {t('cta')}
              <PiArrowRightBold />
            </Link>
