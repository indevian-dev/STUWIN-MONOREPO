...
import AuthLogoutButtonWidget from '@/app/[locale]/auth/logout/AuthLogoutButton.widget';
    ...
    return (
        <div className="relative">
            <button
                ...
                className="flex items-center gap-2 p-2 hover:bg-app-bright-green rounded-app transition-colors"
            >
                <div className="w-8 h-8 rounded-app-full bg-app-bright-green text-white flex items-center justify-center font-bold text-xs border border-white/20">
            ...
            {isOpen && (
                <div
                    ref={dropdownRef}
                    className={`sticky bg-white border border-gray-200 rounded-app shadow-xl z-50 ${isMobile ? 'w-64' : 'w-72'}`}
                    style={dropdownStyle}
                >
                        ...
                        <>
                            <div className="p-4 border-b border-gray-100 bg-gray-50">
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 rounded-app-full bg-app-bright-green text-white flex items-center justify-center font-bold text-lg border border-app/20">
                                        {getInitials(fullName)}
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="max-h-48 overflow-y-auto">
                                        {alternativeWorkspaces.map((workspace) => (
                                            ...
                                            >
                                                <div className="w-8 h-8 rounded-app-full bg-gray-100 flex items-center justify-center text-gray-500 font-bold text-xs border border-gray-200">
                    ...
                    {!isAuthenticated && !contextLoading && (
                        <div className="p-4">
                            ...
                            <div className="space-y-2">
                                <Link
                                    href="/auth/login"
                                    className="w-full px-4 py-3 flex items-center justify-center gap-3 bg-app-bright-green text-white rounded-app hover:bg-app-bright-green-dark transition-colors text-sm font-medium"
                                    onClick={() => setIsOpen(false)}
                                >
                                ...
                                <Link
                                    href="/auth/register"
                                    className="w-full px-4 py-3 flex items-center justify-center gap-3 border border-gray-300 text-gray-700 rounded-app hover:bg-gray-50 transition-colors text-sm font-medium"
                                    onClick={() => setIsOpen(false)}
                                >
