...
export function PublicFooterWidget() {
  ...
  return (
    <>
      <footer
        className="p-4 relative z-10 bg-brand-secondary text-light pt-16 md:pt-20 lg:pt-24 w-full"
        data-wow-delay=".1s"
      >
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-brand dark:hover:text-brand"
                  >
                    <svg
                      width="9"
                      height="18"
                  ...
                  <a
                    href="/"
                    aria-label="social-link"
                    className="dark:text-body-color-dark text-body-color duration-300 hover:text-brand dark:hover:text-brand"
                  >
                    <svg
                      width="17"
                      height="16"
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/blogs"
                      className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-brand dark:hover:text-brand"
                    >
                      Blog
                    </a>
                  </li>
        ...
        <div className="absolute right-0 top-14 z-[-1] rotate-180">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="var(--sg-brand)" stopOpacity="0.62" />
                <stop offset="1" stopColor="var(--sg-brand)" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="var(--sg-brand)" stopOpacity="0" />
                <stop offset="1" stopColor="var(--sg-brand)" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
