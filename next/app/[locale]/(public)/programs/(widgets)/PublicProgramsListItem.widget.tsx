...
export function PublicProgramsListItemWidget({ program }: PublicProgramsListItemWidgetProps): React.JSX.Element | null {
    ...
    return (
        <Link
            ...
            className="block h-full bg-white border border-gray-200 rounded-app overflow-hidden hover:shadow-xl transition-all duration-300 group"
        >
            ...
            <div className="relative w-full aspect-[16/10] bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
                ...
                />
                {program.isActive && (
                    <div className="absolute top-3 right-3 bg-app-bright-green text-white px-3 py-1 rounded-app-full flex items-center gap-1.5 text-xs font-semibold shadow-sm">
            ...
            <div className="p-5 flex flex-col h-[calc(100%-16/10*w)] min-h-[160px]">
                {/* Title */}
                <h3 className="font-bold text-lg text-gray-900 mb-2 line-clamp-2 group-hover:text-app-bright-green transition-colors">
                ...
                <div className="mt-auto space-y-2 pt-4 border-t border-gray-100">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-1.5 text-sm font-semibold text-app-bright-green">
                        ...
                        <span className="text-xs font-medium text-app-bright-green hover:underline">
                            Ətraflı →
                        </span>
                    </div>
                </div>
