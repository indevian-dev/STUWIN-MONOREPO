...
export function PublicProviderApplicationFormWidget() {
  ...
  if (submitted) {
    return (
      <div className="bg-green-50 border border-green-200 rounded-app p-8 text-center">
        <div className="w-16 h-16 bg-green-500 rounded-app-full flex items-center justify-center mx-auto mb-4">
        ...
        <button
          ...
          className="px-6 py-2 bg-app-bright-green text-white rounded-app hover:bg-app-bright-green/90 transition-colors"
        >
  ...
  return (
    <div className="bg-white rounded-app shadow-sm border border-gray-200 p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-app focus:ring-2 focus:ring-app focus:border-transparent ${errors.Provider_name ? 'border-red-500' : 'border-gray-300'
              }`}
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full px-4 py-2 border rounded-app focus:ring-2 focus:ring-app focus:border-transparent ${errors.contact_name ? 'border-red-500' : 'border-gray-300'
              }`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-4 py-2 border rounded-app focus:ring-2 focus:ring-app focus:border-transparent ${errors.email ? 'border-red-500' : 'border-gray-300'
                }`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-4 py-2 border rounded-app focus:ring-2 focus:ring-app focus:border-transparent ${errors.phone ? 'border-red-500' : 'border-gray-300'
                }`}
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            maxLength={10}
            className={`w-full px-4 py-2 border rounded-app focus:ring-2 focus:ring-app focus:border-transparent ${errors.voen ? 'border-red-500' : 'border-gray-300'
              }`}
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full px-4 py-2 border rounded-app focus:ring-2 focus:ring-app focus:border-transparent ${errors.Provider_address ? 'border-red-500' : 'border-gray-300'
              }`}
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            disabled={loading}
            className="px-8 py-3 bg-app-bright-green text-white rounded-app font-medium hover:bg-app-bright-green/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
