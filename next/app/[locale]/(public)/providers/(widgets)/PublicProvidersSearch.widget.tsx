    ...
    <div className="relative w-full">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-app focus:ring-2 focus:ring-app focus:border-transparent bg-white"
        />
        {searchTerm && (
          <button
            onClick={handleClear}
            className="absolute inset-y-0 right-0 flex items-center pr-3 hover:text-app-bright-green transition-colors"
          >
