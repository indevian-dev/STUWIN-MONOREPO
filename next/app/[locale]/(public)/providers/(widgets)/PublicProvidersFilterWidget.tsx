    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4">
      ...
      <div className="flex items-center justify-between mb-4">
        <button
          ...
          className="flex items-center gap-2 font-medium text-gray-900 hover:text-brand transition-colors"
        >
          <FiFilter size={20} />
          <span>Filterlər</span>
          {hasActiveFilters && (
        ...
        <div className="space-y-4 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand focus:border-transparent mb-2"
            >
