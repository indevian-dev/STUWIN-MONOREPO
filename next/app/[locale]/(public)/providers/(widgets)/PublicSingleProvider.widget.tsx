...
export function PublicSingleProviderWidget({ Provider }: PublicSingleProviderWidgetProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      {/* Header Section */}
      <div className="bg-white rounded-app shadow-sm border border-gray-200 overflow-hidden mb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
          {/* Logo */}
          <div className="md:col-span-1">
            <div className="relative w-full aspect-square bg-gradient-to-br from-blue-50 to-indigo-50 rounded-app overflow-hidden">
              <Image
                src={logoUrl}
          ...
          <div className="md:col-span-2 flex flex-col justify-center">
            <div className="flex items-start gap-3 mb-4">
              ...
              {Provider.is_active && (
                <span className="inline-flex items-center gap-1 bg-green-100 text-green-800 px-3 py-1 rounded-app-full text-sm font-medium">
            ...
            <div className="space-y-2">
              ...
              {Provider.phone && (
                <div className="flex items-center gap-2 text-gray-700">
                  <FiPhone size={18} />
                  <a href={`tel:${Provider.phone}`} className="hover:text-app-bright-green">
                    {Provider.phone}
                  </a>
                </div>
              )}
              ...
              {Provider.email && (
                <div className="flex items-center gap-2 text-gray-700">
                  <FiMail size={18} />
                  <a href={`mailto:${Provider.email}`} className="hover:text-app-bright-green">
                    {Provider.email}
                  </a>
                </div>
              )}
              ...
              {Provider.website && (
                <div className="flex items-center gap-2 text-gray-700">
                  ...
                  <a
                    ...
                    className="hover:text-app-bright-green"
                  >
                    {Provider.website}
                  </a>
                </div>
      ...
      {/* Tabs */}
      <div className="bg-white rounded-app shadow-sm border border-gray-200 overflow-hidden">
          ...
          {activeTab === 'about' && (
            <div className="prose max-w-none">
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 p-4 rounded-app">
