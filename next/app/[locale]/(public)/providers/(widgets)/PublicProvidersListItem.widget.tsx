...
export function PublicProvidersListItemWidget({ Provider }: PublicProvidersListItemWidgetProps): React.JSX.Element | null {
  ...
  return (
    <Link
      ...
      className="block h-full bg-white border border-gray-200 rounded-app overflow-hidden hover:shadow-lg transition-all duration-300 group"
    >
      ...
      <div className="relative w-full aspect-video bg-gradient-to-br from-blue-50 to-indigo-50 overflow-hidden">
        ...
        />
        {Provider.isActive && (
          <div className="absolute top-2 right-2 bg-green-500 text-white px-2 py-1 rounded-app-full flex items-center gap-1 text-xs font-medium">
      ...
      <div className="p-4">
        {/* Title */}
        <h3 className="font-semibold text-base text-gray-900 mb-2 line-clamp-2 group-hover:text-app-bright-green transition-colors">
