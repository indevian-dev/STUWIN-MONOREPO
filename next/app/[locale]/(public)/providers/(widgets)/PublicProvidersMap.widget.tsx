...
export function PublicProvidersMapWidget({ Providers = [] }: PublicProvidersMapWidgetProps) {
      ...
      const popupContent = `
        <div class="p-2">
          ...
          <a 
            ...
            class="text-xs text-app-bright-green hover:underline"
          >
            Ətraflı bax
          </a>
        </div>
  ...
  if (!process.env.NEXT_PUBLIC_MAPBOX_TOKEN) {
    return (
      <div className="w-full h-[500px] bg-gray-100 rounded-app flex items-center justify-center">
  ...
  return (
    <div className="w-full h-[500px] rounded-app overflow-hidden border border-gray-200">
