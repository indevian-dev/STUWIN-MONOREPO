...
import { PdfToolPdfUploadWidget } from './PdfToolPdfUpload.widget';
import { PdfToolImagesToPdfModalWidget } from './PdfToolImagesToPdfModal.widget';
import { PdfToolHtmlToPdfModalWidget } from './PdfToolHtmlToPdfModal.widget';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-app p-6 shadow-sm">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="flex-1">
            ...
            {generatedPdfUrl && (
              <div className="mt-4 bg-emerald-50 border border-emerald-200 rounded-app p-4">
        ...
        {/* Info Box */}
        <div className="bg-blue-50 border border-blue-200 rounded-app p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white border-2 border-gray-200 rounded-app p-6 hover:border-emerald-400 transition-colors">
          <div className="flex flex-col items-center text-center mb-4">
            <div className="w-16 h-16 bg-red-100 rounded-app-full flex items-center justify-center mb-3">
          ...
          <div className="space-y-2 text-xs text-gray-500">
            <div className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 bg-emerald-500 rounded-app-full" />
        ...
        <button
          ...
          className="bg-white border-2 border-gray-200 rounded-app p-6 hover:border-emerald-400 hover:shadow-md transition-all text-left"
        >
          <div className="flex flex-col items-center text-center mb-4">
            <div className="w-16 h-16 bg-purple-100 rounded-app-full flex items-center justify-center mb-3">
        ...
        >
          <div className="flex flex-col items-center text-center mb-4">
            <div className="w-16 h-16 bg-blue-100 rounded-app-full flex items-center justify-center mb-3">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-app p-6">
