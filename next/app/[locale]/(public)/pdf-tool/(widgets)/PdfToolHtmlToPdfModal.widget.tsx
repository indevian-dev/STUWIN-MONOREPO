...
export function PdfToolHtmlToPdfModalWidget({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950 bg-opacity-90 z-50 flex justify-center items-center p-4 overflow-y-auto">
      <div className="bg-white rounded-app w-full max-w-6xl shadow-xl my-8 max-h-[90vh] flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-app focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:opacity-50 disabled:bg-gray-50"
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="border border-gray-300 rounded-app overflow-hidden">
              <Editor
                ref={editorRef}
          ...
          {/* Success Message */}
          {generatedPdfUrl && (
            <div className="mb-4 p-4 bg-emerald-50 border border-emerald-200 rounded-app">
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50">
          ...
          <button
            ...
            className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-app font-medium disabled:opacity-50 transition-colors flex items-center gap-2"
          >
