...
import { PublicQuestionsListWidget } from '@/app/[locale]/(public)/questions/(widgets)/PublicQuestionsList.widget';
import { PublicCardsSearchWidget } from '@/app/[locale]/(public)/filters/(widgets)/PublicQuestionsSearch.widget';
import { PublicCardsSortWidget } from '@/app/[locale]/(public)/filters/(widgets)/PublicQuestionsSort.widget';
import { PublicCardsFiltersWidget } from '@/app/[locale]/(public)/filters/(widgets)/PublicQuestionsFilters.widget';
                    ...
                    <div className="col-span-9">
                        {error ? (
                            ...
                            <div className='flex justify-center items-center py-12'>
                                <div className='animate-spin rounded-app-full h-8 w-8 border-b-2 border-app'></div>
