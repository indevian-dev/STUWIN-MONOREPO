...
export function PublicCardsFiltersWidget({
    ...
    return (
        <div className={`filter-section ${className} flex flex-col gap-4 mb-6 w-full text-app-dark-blue dark:text-white text-md items-start`}>
            {/* Category Selection */}
                            ...
                            {cardOption.type === 'DYNAMIC' ? (
                                <div className="flex items-center space-x-2 w-full">
                                    <input
                                        ...
                                        className="form-input px-2 py-1 rounded border border-app-light w-full"
                ...
                <div className="rounded space-y-2 w-full">
                    ...
                    <div className="price-filter w-full flex gap-2 ">
                        <input
                            ...
                            className='w-full rounded border border-app-light p-2'
                        />
                        <input
                            type="number"
                            id="maxPrice"
            ...
            <div className="col-span-12 flex items-center justify-between gap-4 w-full mt-4">
                <button
                    ...
                    className="flex-1 px-4 py-2 bg-app-bright-green-dark hover:bg-app-bright-green-dark/80 text-white font-medium rounded-app transition-colors duration-200 border border-app-dark"
                >
                    Clear
                </button>
                <button
                    ...
                    className="flex-1 px-4 py-2 bg-app-bright-green hover:bg-app-bright-green/80 text-white font-medium rounded-app transition-colors duration-200 border border-app"
                >
                    Apply
                </button>
            </div>
