                ...
                <div className="relative w-full">
                    ...
                    <div className="relative flex items-center">
                        ...
                        <button
                            ...
                            className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-primary text-white px-3 py-1 rounded-app hover:bg-primary-dark disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                            aria-label="Search"
                        >
