    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-50 p-6">
            <div className="max-w-md w-full bg-white rounded-[3rem] p-10 md:p-14 shadow-2xl shadow-dark/5 border border-slate-100 text-center space-y-8">
                <div className="w-20 h-20 bg-red-50 text-red-500 rounded-app flex items-center justify-center text-5xl mx-auto">
                    <PiXCircleBold />
                </div>

                <div className="space-y-2">
                    <h2 className="text-3xl font-black text-app-dark-blue dark:text-white tracking-tight">Payment Failed</h2>
                    <p className="text-neutral-500 font-medium leading-relaxed">
                        Something went wrong during the checkout process. No funds were charged from your account.
                    </p>
                </div>

                <div className="p-6 bg-orange-50 rounded-app border-2 border-orange-100 flex gap-4 text-left">
                ...
                <div className="pt-4 space-y-3">
                    <button
                        onClick={() => router.back()}
                        className="w-full h-16 bg-app-bright-green-dark text-white font-black rounded-app flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition-all"
                    >
                        <PiArrowLeftBold />
                        Try Again
                    </button>
                    <button
                        ...
                        className="w-full h-16 bg-white text-app-dark-blue dark:text-white font-black rounded-app border-2 border-slate-100 hover:bg-neutral-50 transition-all"
                    >
                        Cancel & Return
                    </button>
                </div>
