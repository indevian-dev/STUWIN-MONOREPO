                        ...
                        <div className="grid grid-cols-1 gap-3">
                            {searchResults.map((account) => (
                                <div
                                    ...
                                    className={`bg-app-bright-green-light rounded p-4 cursor-pointer transition hover:ring-2 hover:ring-blue-400 ${selectedAccount?.accountId === account.accountId
                    ...
                    {loadingWorkspaces ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {filteredWorkspaces.map((wa, i) => (
                                <div key={`${wa.workspace.id}-${i}`} className="bg-app-bright-green-light rounded p-4">
