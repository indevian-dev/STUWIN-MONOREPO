...
export function StaffUsersListWidget() {
    ...
    const handleCreateAccount = async (userId: string) => {
        try {
            ...
            const updatedResponse = await fetchApiUtil<any>({
                method: 'GET',
                url: `/api/workspaces/staff/${workspaceId}/users`,
                params: {
                    page,
        ...
        <div className='w-full p-4'>
            ...
            {isRoleModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded-app max-w-md w-full">
                        ...
                        <div className="mb-4">
                            ...
                            <div className="mt-1 space-y-1">
                                <div className="flex items-center">
                                    <div className={`w-4 h-4 mr-2 rounded-app-full flex items-center justify-center ${passwordValidation.hasMinLength ? 'bg-emerald-500' : 'bg-rose-500'}`}>
                                ...
                                <div className="flex items-center">
                                    <div className={`w-4 h-4 mr-2 rounded-app-full flex items-center justify-center ${passwordValidation.hasNumber ? 'bg-emerald-500' : 'bg-rose-500'}`}>
                        ...
                        <div className="mb-6">
                            ...
                            {passwordData.confirmPassword && (
                                <div className="flex items-center mt-1">
                                    <div className={`w-4 h-4 mr-2 rounded-app-full flex items-center justify-center ${passwordValidation.passwordsMatch ? 'bg-emerald-500' : 'bg-rose-500'}`}>
            ...
            <div className="grid grid-cols-1 gap-4">
                {users.map((user) => (
                    <div key={user.id} className="bg-app-bright-green-light rounded p-4 grid grid-cols-2 gap-4">
                        <div className="grid grid-cols-1 items-center w-full">
                            <div className="relative h-12 w-12 rounded-app-full overflow-hidden shrink-0">
                                <GlobalImagePlaceholderTile aspect="" className="absolute inset-0 h-full w-full rounded-app-full" />
                                <img
                                    className="absolute inset-0 h-full w-full rounded-app-full object-cover z-10"
