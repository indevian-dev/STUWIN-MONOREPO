...
import { StaffSubjectAddModalWidget } from './StaffSubjectAddModal.widget';
import { StaffSubjectEditModalWidget } from './StaffSubjectEditModal.widget';
import { fetchApiUtil } from '@/lib/utils/Http.FetchApiSPA.util';
import { Subject } from '@stuwin/shared/types/domain/Subject.types';
import { ApiResponse, SuccessApiResponse } from '@stuwin/shared/types/api/ApiResponse.types';
...
export function StaffSubjectsListWidget() {
  ...
  const renderSubjects = (subjects: OrganizedSubject[]): React.ReactElement[] => {
    return subjects.map((subject) => (
      <div key={subject.id} className="p-4 bg-white border border-gray-200 rounded-app shadow-sm hover:shadow-md transition-shadow">
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="mb-6 flex flex-col md:flex-row gap-4 justify-between items-start md:items-center bg-gray-50 p-4 rounded-app border border-gray-200">
        <div className="flex flex-wrap gap-4 items-center">
          <div>
            ...
            <select
              ...
              className="block w-full text-sm border-gray-300 rounded-app focus:ring-emerald-500 focus:border-emerald-500 bg-white px-2 py-1 border"
            >
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-gray-50 rounded-app border-2 border-dashed border-gray-300">
      ...
      {showDeleteConfirmationModal && (
        <div className="fixed inset-0 bg-slate-950 bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-app shadow-xl max-w-md">
