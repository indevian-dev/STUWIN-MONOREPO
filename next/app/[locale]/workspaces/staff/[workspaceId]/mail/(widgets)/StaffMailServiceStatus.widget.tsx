...
export function StaffMailServiceStatusWidget() {
  ...
  const fetchServiceStatus = async () => {
    try {
      setRefreshing(true)
      const response = await fetch('/api/workspaces/staff/mail/status')
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-app shadow p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            disabled={refreshing}
            className="flex items-center px-3 py-1 text-sm bg-gray-100 text-gray-700 rounded-app hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-app focus:ring-offset-2 disabled:opacity-50"
          >
        ...
        {error ? (
          <div className="p-4 bg-rose-50 border border-rose-200 rounded-app">
          ...
          <div className={`p-4 border rounded-app ${getStatusColor(status?.status)}`}>
            <div className="flex items-center">
      ...
      {status && (
        <div className="bg-white rounded-app shadow p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-app">
              <span className="text-sm font-medium text-gray-700">API Key Configured</span>
              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-app-full text-xs font-medium ${status.api_configured
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-app">
              ...
              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-app-full text-xs font-medium ${status.smtp_configured
                ? 'bg-emerald-100 text-emerald-800'
                : 'bg-rose-100 text-rose-800'
                }`}>
      ...
      <div className="bg-white rounded-app shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-blue-50 p-4 rounded-app">
          ...
          <div className="bg-emerald-50 p-4 rounded-app">
          ...
          <div className="bg-yellow-50 p-4 rounded-app">
          ...
          <div className="bg-purple-50 p-4 rounded-app">
      ...
      <div className="bg-white rounded-app shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <a
            ...
            className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-app text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-app focus:ring-offset-2"
          >
            Open ZeptoMail Dashboard
          </a>
