...
export function StaffMailConfigurationWidget() {
  ...
  const fetchConfiguration = async () => {
    try {
      const response = await fetch('/api/workspaces/staff/mail/config')
  ...
  const handleTestConnection = async () => {
    ...
    try {
      const response = await fetch('/api/workspaces/staff/mail/test', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    <div className="space-y-6">
        ...
        <form onSubmit={handleSaveConfiguration} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="block w-full px-3 py-2 pr-10 border border-gray-300 rounded-app shadow-sm focus:outline-none focus:ring-app focus:border-app"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    required
                    className="block w-full px-3 py-2 border border-gray-300 rounded-app shadow-sm focus:outline-none focus:ring-app focus:border-app"
          ...
          <div className="flex space-x-4">
            <button
              type="submit"
              disabled={saving}
              className="px-4 py-2 bg-app-bright-green text-white rounded-app hover:bg-app-bright-green/90 focus:outline-none focus:ring-2 focus:ring-app focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="px-4 py-2 bg-gray-600 text-white rounded-app hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      <div className="bg-white rounded-app shadow p-6">
        ...
        <div className="space-y-4 text-sm text-gray-600">
          ...
          <div className="bg-yellow-50 p-3 rounded-app">
