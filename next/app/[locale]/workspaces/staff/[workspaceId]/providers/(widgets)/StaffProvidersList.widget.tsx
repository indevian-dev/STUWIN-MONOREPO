...
export function StaffProvidersListWidget() {
    ...
    const getStatusBadge = (Provider: Provider) => {
        if (!Provider.is_active) {
            return <span className="px-2 py-1 text-xs rounded-app-full bg-gray-100 text-gray-800">Inactive</span>;
        }
        return <span className="px-2 py-1 text-xs rounded-app-full bg-emerald-100 text-emerald-800">Active</span>;
    };
            ...
            <div className="grid grid-cols-1 gap-4">
                {Providers.length === 0 ? (
                    ...
                    Providers.map((Provider) => (
                        <div key={Provider.id} className="bg-white rounded-app shadow border p-6">
                                    ...
                                    <div className="flex items-start gap-4">
                                        {Provider.logo && (
                                            <Image
                                                ...
                                                alt={Provider.title}
                                                className="w-16 h-16 rounded-app object-cover"
                                                width={64}
                                                height={64}
                                            />
                                        )}
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center justify-center gap-2 px-3 py-2 text-sm rounded ${Provider.is_active
                                            ? 'bg-app-bright-green-warning text-gray-800 hover:bg-yellow-400'
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded text-white ${selectedProvider.is_active
                                            ? 'bg-app-bright-green-warning hover:bg-yellow-500'
