                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full rounded-lg border border-gray-300 px-3 py-2 h-24 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none"
                                    />
                                </div>
                                {createError && (
                        ...
                        filteredRoles.map((role) => (
                            <div key={role.id} className="grid grid-cols-12 py-4 px-4 hover:bg-blue-50/30 transition-colors items-center">
                                ...
                                <div className="col-span-3">
                                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${role.forWorkspaceType === 'staff' ? 'bg-purple-100 text-purple-800' :
                                ...
                                <div className="col-span-2 text-right">
                                    <Link
                                        ...
                                        className="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-xs font-bold rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all"
                                    >
                                        Manage
                                    </Link>
                                </div>
