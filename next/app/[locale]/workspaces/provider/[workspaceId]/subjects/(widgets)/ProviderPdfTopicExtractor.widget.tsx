...
import type { SubjectPdf } from "./ProviderSubjectDetail.widget";
...
export function ProviderPdfTopicExtractorWidget({
  ...
  const handleExtractTopics = async (): Promise<void> => {
    ...
    try {
      ...
      const analysisResponseData = await fetchApiUtil<any>({
        method: "POST",
      ...
      const response = await fetchApiUtil<any>({
        ...
        body: {
          topics: extractedTopics.map(topic => ({
            ...
            pdfFileName: selectedPdf.pdfUrl.split("/").pop() || "",
  ...
  return (
    <div className="fixed inset-0 bg-slate-950 bg-opacity-90 z-50 flex justify-center items-center p-4 overflow-y-auto">
      <div className="bg-white rounded-app w-full max-w-5xl shadow-xl my-8 max-h-[90vh] flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-6">
            ...
            <>
              ...
              <div className="mb-6">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-app focus:outline-none focus:ring-2 focus:ring-purple-500"
                >
              ...
              {/* Info Box */}
              <div className="mt-6 bg-blue-50 border border-blue-200 rounded-app p-4">
            ...
            <>
              ...
              <div className="space-y-2 mb-4">
                {extractedTopics.map((topic, index) => (
                  <div
                    key={topic.id}
                    className="border border-gray-200 rounded-app p-4 bg-white hover:border-gray-300 transition-colors"
                  >
                    {topic.editing ? (
          ...
          {stage === "creating" && (
            <div className="text-center py-12">
              ...
              <div className="w-full max-w-md mx-auto bg-gray-200 rounded-app-full h-3">
                <div
                  className="bg-purple-500 h-3 rounded-app-full transition-all duration-300"
                  style={{
          ...
          {stage === "complete" && (
            <div className="text-center py-12">
              <div className="w-16 h-16 bg-emerald-100 rounded-app-full flex items-center justify-center mx-auto mb-4">
          ...
          {stage === "error" && error && (
            <div className="text-center py-12">
              <div className="w-16 h-16 bg-red-100 rounded-app-full flex items-center justify-center mx-auto mb-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-app"
              >
                Try Again
              </button>
            </div>
          ...
          {/* Error Message */}
          {error && stage !== "error" && (
            <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-app">
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50">
          <button
            ...
            className="px-4 py-2 border border-gray-300 bg-white hover:bg-gray-50 rounded-app text-gray-700 font-medium disabled:opacity-50 transition-colors"
          >
          ...
          {stage === "select" && selectedPdfId && gradeLevel && (
            <button
              ...
              className="px-4 py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-app font-medium transition-colors flex items-center gap-2"
            >
          ...
          {stage === "review" && extractedTopics.length > 0 && (
            <button
              ...
              className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-app font-medium transition-colors flex items-center gap-2"
            >
