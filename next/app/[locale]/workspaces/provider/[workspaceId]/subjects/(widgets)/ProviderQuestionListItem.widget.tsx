...
import { VisualGenerationModal } from "./VisualGeneration.modal";
...
export function ProviderQuestionListItemWidget({
    ...
    const t = useTranslations("ProviderQuestionListItem.widget");
    ...
    return (
        <div className="border border-gray-200 rounded-app overflow-hidden bg-white hover:shadow-sm transition-shadow">
            {/* Header Row */}
            <div
                        ...
                        <div className="space-y-3">
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-3 py-2 border border-gray-300 rounded-app text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                />
                            </div>
                                ...
                                {editData.answers.map((answer, idx) => (
                                    <div key={idx} className="flex items-center gap-2 mb-2">
                                        ...
                                        <input
                                            ...
                                            className="flex-1 px-3 py-1.5 border border-gray-300 rounded-app text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                        />
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="px-4 py-2 bg-green-50 text-green-700 rounded-app text-sm font-medium hover:bg-green-100 transition-colors"
                                >
                                    Save
                                </button>
                                <button
                                    ...
                                    className="px-4 py-2 bg-gray-50 text-gray-700 rounded-app text-sm font-medium hover:bg-gray-100 transition-colors"
                                >
                                    {t("cancel")}
                                </button>
                            </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-1.5">
                                {question.answers.map((answer, idx) => (
                                    <div
                                        key={idx}
                                        className={`flex items-center gap-2 px-3 py-2 rounded-app text-sm ${answer === question.correctAnswer
                            ...
                            <div className="flex items-center gap-2 pt-2">
                                <button
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-blue-700 bg-blue-50 rounded-app hover:bg-blue-100 transition-colors"
                                >
                                    <PiPencil size={14} />
                                    {t("edit")}
                                </button>
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-app transition-colors ${question.aiGuide
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-app transition-colors ${question.visualData
                                ...
                                {!question.isPublished && (
                                    <button
                                        ...
                                        disabled={publishing}
                                        className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-green-700 bg-green-50 rounded-app hover:bg-green-100 transition-colors disabled:opacity-50"
                                    >
                                        <PiSealCheck size={14} />
                                ...
                                {confirmDelete ? (
                                    <div className="flex items-center gap-2 ml-auto">
                                        <button
                                            ...
                                            disabled={deleting}
                                            className="px-3 py-1.5 text-sm font-medium text-red-700 bg-red-50 rounded-app hover:bg-red-100 transition-colors disabled:opacity-50"
                                        >
                                            {deleting ? t("deleting") : t("confirm_delete")}
                                        </button>
                                        <button
                                            onClick={() => setConfirmDelete(false)}
                                            className="px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-50 rounded-app hover:bg-gray-100 transition-colors"
                                        >
                                            {t("cancel")}
                                        </button>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-red-600 bg-red-50 rounded-app hover:bg-red-100 transition-colors ml-auto"
                                    >
                                        <PiTrash size={14} />
                                        {t("delete")}
                                    </button>
