...
// useState, useEffect removed as component is now stateless controlled
...
export function ProviderAnswersEditorWidget({ answers, correctAnswer, onAnswersChange, onCorrectAnswerChange, errors }: ProviderAnswersEditorWidgetProps) {
  // Use props directly with fallback if needed, ensuring controlled component behavior
  const currentAnswers = answers && answers.length > 0 ? answers : ['', '', '', ''];
