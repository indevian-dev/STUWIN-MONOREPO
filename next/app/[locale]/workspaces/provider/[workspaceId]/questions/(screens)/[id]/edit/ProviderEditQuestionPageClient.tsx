...
interface QuestionWithDetails extends QuestionType.PrivateAccess {
  created_at?: string;
  authorEmail?: string;
  author_email?: string;
  subjectTitle?: string;
      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <ProviderQuestionFormWidget
          ...
          initialData={{
            ...
            grade_level: typeof question.gradeLevel === 'string' ? parseInt(question.gradeLevel) : question.gradeLevel,
