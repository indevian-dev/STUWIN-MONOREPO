      ...
      <div className="bg-white rounded-app shadow-sm border border-neutral-200 p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-app-dark-blue dark:text-white flex items-center gap-2">
        ...
        <div className="mt-6 pt-6 border-t border-neutral-200">
          <label className="flex items-center gap-3">
            <input
              ...
              className="w-4 h-4 text-app-bright-green border-neutral-300 rounded focus:ring-app"
            />
        ...
        <div className="flex justify-end gap-4 mt-8 pt-6 border-t border-neutral-200">
          ...
          <button
            type="submit"
            className="px-6 py-2 bg-app-bright-green text-white rounded-app hover:bg-app-bright-green/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={saving}
          >
