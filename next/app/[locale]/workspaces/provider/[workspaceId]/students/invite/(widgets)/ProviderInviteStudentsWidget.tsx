      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
        ...
        {!useBulkMode && (
          <div className="space-y-4 mb-6">
            <h3 className="text-lg font-medium text-dark">{t('student_emails')}</h3>
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-brand hover:bg-brand/10 rounded-md transition-colors"
            >
        ...
        {useBulkMode && (
          <div className="mb-6">
            <h3 className="text-lg font-medium text-dark mb-4">{t('bulk_email_input')}</h3>
            <textarea
              value={bulkEmails}
            ...
            <button
              ...
              className="mt-2 px-4 py-2 bg-neutral-100 text-neutral-700 rounded-md hover:bg-neutral-200 transition-colors"
            >
              {t('parse_emails')}
            </button>
          </div>
        ...
        {/* Invitation Message */}
        <div className="mb-6">
          <h3 className="text-lg font-medium text-dark mb-4">{t('invitation_message')}</h3>
          <textarea
