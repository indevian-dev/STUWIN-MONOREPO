...
export function ProviderOrganizationEditWidget({
  ...
  const inputClass =
    'w-full px-3 py-2 border border-neutral-300 rounded-app text-sm focus:outline-none focus:ring-2 focus:ring-app/40 focus:border-app transition-colors';
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex justify-end gap-3 pt-2">
        <button
          ...
          onClick={onCancel}
          disabled={saving}
          className="px-5 py-2.5 border border-neutral-300 rounded-app text-neutral-700 hover:bg-neutral-50 transition-colors text-sm font-medium disabled:opacity-50"
        >
          {t('cancel')}
        </button>
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-app-bright-green text-white rounded-app hover:bg-app-bright-green/80 transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
        >
