...
import { StudentLearningSessionModal } from '../../learning/(widgets)/StudentLearningSession.modal';
...
export function StudentQuizResultsWidget({ quiz }: StudentQuizResultsWidgetProps) {
  ...
  return (
    <div className='w-full max-w-5xl mx-auto space-y-6'>
      {/* Score Card */}
      <div className='bg-white rounded-app shadow-md p-8 text-center'>
        <div className={`inline-flex items-center justify-center w-32 h-32 rounded-app-full mb-4 ${isPassed ? 'bg-green-100' : 'bg-red-100'
          }`}>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mt-6'>
          <div className='bg-gray-50 rounded-app p-4'>
        ...
        <div className='space-y-4'>
          {result.details && result.details.map((detail: any, index: number) => {
            ...
            return (
              <div
                key={index}
                className={`border-l-4 p-4 rounded-r-app ${detail.is_correct
              ...
              >
                ...
                <div className='mt-4 pt-3 border-t border-gray-200'>
                  <button
                    ...
                    className='flex items-center gap-2 px-4 py-2 bg-app-bright-green text-secondary text-sm font-medium rounded-app hover:from-purple-700 hover:to-indigo-700 transition-all shadow-sm hover:shadow-md'
                  >
                    <svg
                      className='w-4 h-4'
                      fill='none'
      ...
      <div className='flex gap-4 justify-center'>
        <Link
          ...
          className='px-6 py-3 bg-gray-200 text-gray-800 font-semibold rounded-app hover:bg-gray-300 transition-colors'
        >
          View Quiz History
        </Link>
