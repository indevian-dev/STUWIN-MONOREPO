...
export function StudentQuizReportWidget({ quizId, onBack }: StudentQuizReportWidgetProps) {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 pb-12">
            ...
            {/* Hero Header */}
            <div className="bg-gradient-to-br from-app to-app-dark rounded-app p-8 text-white shadow-xl overflow-hidden relative">
                <div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
                    <PiChartLine size={120} />
                </div>
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                        <span className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-app-full text-[10px] font-bold uppercase tracking-widest">
                            AI Insight Report
                        </span>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-green-50/50 border border-green-100 rounded-app p-6 space-y-3">
                ...
                <div className="bg-orange-50/50 border border-orange-100 rounded-app p-6 space-y-3">
                ...
                <div className="bg-app-bright-green/5 border border-app/10 rounded-app p-6 space-y-3">
                    <div className="flex items-center gap-2 text-app-bright-green">
                        <PiLightbulb size={24} />
                        <h3 className="font-bold text-sm uppercase tracking-wider">Next Steps</h3>
                    </div>
                    <ul className="space-y-2">
                        {learningInsights.recommendations?.map((r, i) => (
                            <li key={i} className="text-sm text-app-dark-blue dark:text-white font-medium flex gap-2">
            ...
            {/* Detailed Analysis */}
            <div className="bg-white rounded-app border border-gray-100 shadow-sm p-8 space-y-6">
                <div className="flex items-center gap-3 border-b border-gray-100 pb-4">
                    <div className="p-2 bg-gray-50 rounded-app">
                        <PiRobot size={24} className="text-app-bright-green" />
                    </div>
                    <h2 className="text-xl font-bold text-gray-900">Detailed Tutor Analysis</h2>
                </div>

                <div className="prose prose-app max-w-none text-gray-700 leading-relaxed">
