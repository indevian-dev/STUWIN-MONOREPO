...
export function StudentHomeworkUploadWidget() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const createResponse = await fetchApiUtil<any>({
      ...
      if (files.length > 0) {
        for (const file of files) {
          ...
          const uploadResponse = await fetchApiUtil<any>({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-app shadow-sm p-6 max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              disabled={isLoading}
              className="w-full px-4 py-2 border border-gray-300 rounded-app focus:ring-2 focus:ring-primary focus:border-transparent disabled:bg-gray-100"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              disabled={isLoading}
              rows={2}
              className="w-full px-4 py-2 border border-gray-300 rounded-app focus:ring-2 focus:ring-primary focus:border-transparent disabled:bg-gray-100 resize-none"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              disabled={isLoading}
              rows={6}
              className="w-full px-4 py-2 border border-gray-300 rounded-app focus:ring-2 focus:ring-primary focus:border-transparent disabled:bg-gray-100 resize-vertical"
            />
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-app p-8 text-center hover:border-primary transition cursor-pointer">
              <input
                type="file"
                ...
                {filePreviews.map((item, index) => (
                  <div key={index} className="relative group">
                    {item.preview ? (
                      ...
                      <div className="w-full h-24 bg-gray-100 rounded-app flex items-center justify-center">
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="absolute -top-2 -right-2 p-1 bg-red-500 text-white rounded-app-full opacity-0 group-hover:opacity-100 transition disabled:opacity-50"
                    >
                      <PiX size={16} />
                    </button>
                  </div>
          ...
          <div className="flex gap-4 pt-6">
            <button
              ...
              className="flex-1 px-4 py-2 bg-primary text-white rounded-app hover:bg-primary/90 disabled:bg-gray-300 transition font-medium"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-app hover:bg-gray-50 disabled:opacity-50 transition font-medium"
            >
              Cancel
            </button>
          </div>
