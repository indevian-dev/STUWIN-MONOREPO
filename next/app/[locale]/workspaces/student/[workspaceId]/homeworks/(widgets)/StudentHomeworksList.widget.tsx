...
import { StudentAddHomeworkModalWidget } from "./StudentAddHomeworkModal.widget";
      ...
      <div className="bg-white rounded-app shadow-sm p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-app-bright-green text-white px-4 py-2 rounded-app-primary hover:bg-app-bright-green/80 transition font-medium"
          >
            <PiPlus size={20} />
            Add Homework
          </button>
              ...
              <tbody>
                {homeworks.map((homework) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      <span
                        className={`inline-block px-3 py-1 rounded-app-full text-xs font-medium ${getStatusColor(homework.status)}`}
                      >
                        {homework.status}
                      </span>
                    </td>
