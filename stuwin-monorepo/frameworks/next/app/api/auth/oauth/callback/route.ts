...
import {
  ...
  getOAuthBaseUrl,
  linkOAuthProvider,
} from '@/lib/app-access-control/authenticators/OAuthAuthenticator';
...
import { mapSkopeTypeToDomain } from '@/lib/utils/skopeUtility';
import type { User } from '@/types/resources';
import { ConsoleLogger } from '@/lib/app-infrastructure/loggers/ConsoleLogger';
export const POST: ApiRouteHandler = withApiHandler(async (req, { authData, params }: ApiHandlerContext) => {
  const {
    code,
    provider,
    deviceInfo,
