            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                {images.map((image, index) => (
                  <div key={image.id} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
        ...
        <div className="border-t border-gray-200 p-6">
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              className="px-6 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-medium transition-colors disabled:opacity-50 flex items-center gap-2"
            >
