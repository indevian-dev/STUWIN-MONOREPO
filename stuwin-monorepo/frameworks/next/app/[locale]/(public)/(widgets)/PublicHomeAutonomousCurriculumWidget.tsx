        ...
        <section id="curriculum" className="relative py-24 lg:py-32 bg-slate-50">
            ...
            <div className="relative max-w-7xl mx-auto px-4 w-full">
                <div className="flex flex-col items-center text-left gap-16">
                    ...
                    <div className="relative w-full aspect-[3/1] md:aspect-[5/1] lg:aspect-[6/1] rounded-3xl border border-slate-200 bg-white overflow-hidden shadow-2xl shadow-slate-200/50 flex items-center justify-center group">
