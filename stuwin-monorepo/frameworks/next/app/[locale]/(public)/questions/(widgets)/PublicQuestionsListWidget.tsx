...
export function PublicQuestionItemWidget({ question }: PublicQuestionItemWidgetProps) {
    ...
    return (
        <div className='col-span-12 md:col-span-6 lg:col-span-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 p-4'>
            {/* Question Body */}
            <div className='mb-4'>
                ...
                {answers && Object.entries(answers).map(([key, value]: [string, string]) => {
                    ...
                    return (
                        <button
                            ...
                            className={`w-full text-left p-3 rounded-lg border-2 transition-all duration-200 ${!selectedAnswer
