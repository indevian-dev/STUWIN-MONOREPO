...
import { PublicProgramsListItemWidget } from './PublicProgramsListItemWidget';
import { PublicProgramsSearchWidget } from './PublicProgramsSearchWidget';
            ...
            {!loading && totalPages > 1 && (
                <div className="flex justify-center items-center gap-3 mt-12 pb-10">
                    <button
                        ...
                        disabled={page === 1}
                        className="px-6 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-700 font-medium disabled:opacity-40 disabled:cursor-not-allowed hover:bg-gray-50 hover:border-brand/30 transition-all shadow-sm"
                    >
                        Əvvəlki
                    </button>
                            ...
                            if (
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-10 h-10 flex items-center justify-center rounded-xl font-semibold transition-all ${page === p
