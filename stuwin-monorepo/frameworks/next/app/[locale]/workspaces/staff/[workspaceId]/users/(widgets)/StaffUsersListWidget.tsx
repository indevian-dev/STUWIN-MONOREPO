...
export function StaffUsersListWidget() {
        ...
        const fetchUsers = async () => {
            try {
                ...
                const response = await apiCallForSpaHelper({
                    method: 'GET',
                    url: '/api/workspaces/staff/users',
                    params: {
                        page,
    ...
    useEffect(() => {
        ...
        const fetchRoles = async () => {
            try {
                const response = await apiCallForSpaHelper({
                    method: 'GET',
                    url: '/api/workspaces/staff/roles'
                });
                const data = await response.data;
                setRoles(data.roles || []);
            } catch (error) {
    ...
    const handleCreateAccount = async (userId: string) => {
        try {
            const response = await apiCallForSpaHelper({
                method: 'POST',
                url: '/api/workspaces/staff/accounts/create',
                body: { userId }
            });
    ...
    const handleSuspendToggle = async (accountId: number, suspended: boolean) => {
        try {
            const response = await apiCallForSpaHelper({
                method: 'PUT',
                url: `/api/workspaces/staff/accounts/update/${accountId}`,
    ...
    const handleDeleteUser = async (userId: string) => {
        ...
        try {
            const response = await apiCallForSpaHelper({
                method: 'DELETE',
                url: '/api/workspaces/staff/users/delete',
                body: {
                    userId
                }
            });
    ...
    const submitRoleAssignment = async () => {
        ...
        try {
            const response = await apiCallForSpaHelper({
                method: 'PUT',
                url: `/api/workspaces/staff/accounts/update/${selectedAccountId}`,
    ...
    const submitPasswordUpdate = async () => {
        ...
        try {
            const response = await apiCallForSpaHelper({
                method: 'PUT',
                url: '/api/workspaces/users/update',
                body: {
    ...
    const handleVerifyToggle = async (userId: string, field: string, value: boolean) => {
        try {
            const response = await apiCallForSpaHelper({
                method: 'PUT',
                url: '/api/workspaces/staff/users/update',
                body: {
                    userId,
                    [field]: value
                }
    ...
    const handleAssignProviderScope = async (userId: string) => {
        ...
        try {
            const response = await apiCallForSpaHelper({
                method: 'POST',
                url: '/api/workspaces/staff/users/assign-provider',
                body: {
                    userId
                }
            });
