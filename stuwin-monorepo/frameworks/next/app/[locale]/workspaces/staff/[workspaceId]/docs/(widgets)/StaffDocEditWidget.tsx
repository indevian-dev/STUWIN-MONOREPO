...
export function StaffDocEditWidget({ type = 'about', title = 'About us' }: StaffDocEditWidgetProps) {
    ...
    if (loading) {
        return (
            <div className="w-full bg-white py-12 px-6 rounded-xl shadow-sm border border-gray-100 animate-pulse">
    ...
    return (
        <div className='w-full bg-white py-8 px-6 rounded-xl shadow-sm border border-gray-100'>
            <div className="flex justify-between items-center mb-8 pb-4 border-b border-gray-100">
                ...
                <div className="flex gap-3">
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="px-8 py-2.5 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 active:transform active:scale-95 transition-all shadow-md shadow-blue-500/20 disabled:bg-gray-400 disabled:shadow-none flex items-center gap-2"
                    >
                        {saving ? (
                            <>
