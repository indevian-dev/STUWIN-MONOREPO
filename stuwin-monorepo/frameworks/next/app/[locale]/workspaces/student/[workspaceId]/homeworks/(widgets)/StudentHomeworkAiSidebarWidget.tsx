        ...
        <div className="flex flex-col h-full bg-white border-l border-gray-200 w-full md:w-96 shadow-xl">
            <div className="p-4 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <PiRobot className="text-brand text-xl" />
            ...
            <form onSubmit={handleSendMessage} className="p-4 bg-white border-t border-gray-100">
                <div className="relative">
                    <input
                        ...
                        className="w-full pl-4 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-all disabled:opacity-50"
                    />
                    <button
                        type="submit"
                        disabled={!input.trim() || isLoading || isInitializing}
                        className="absolute right-2 top-1.5 p-2 bg-brand text-white rounded-lg hover:bg-brand-dark transition-colors disabled:opacity-50"
                    >
